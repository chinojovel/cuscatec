                    ...
                    <div>
                        ...
                        <div class="category-slider" style="margin-top: 5px;">
                            ...
                            <div style="margin-right: 3px!important;">
                                <a href="{{ route('ecommerce.products.list') }}"
                            ...
                            @else
                                <div style="margin-right: 3px!important;">
                                    <a href="{{ route('ecommerce.products.list', ['category_id' => $category->id]) }}"
                                        class="category-btn btn btn-secondary mr-2">
                                        {{ $category->name }}
                                    </a>
                                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#searchButton').click(function() {
                    ...
                    let newUrl =
                        `{{ route('ecommerce.products.list') }}?name=${encodeURIComponent(searchValue)}`;
                    if (categoryId) {
