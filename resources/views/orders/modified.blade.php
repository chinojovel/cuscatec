...
@section('content')
    <div class="container">
        ...
        <form method="GET" action="{{ route('administration.orders.modified') }}" class="mb-4">
            <div class="row">
                <!-- Filtro por Cliente -->
                <div class="col-md-4">
            ...
            <div class="mt-3">
                ...
                <a href="{{ route('administration.orders.modified') }}" class="btn btn-secondary">Clear</a>
                <!-- Botón para limpiar -->
            </div>
        </form>
                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('administration.orders.show', $order->id) }}" class="btn m-1 btn-info">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="{{ route('administration.orders.print', $order->id) }}"
