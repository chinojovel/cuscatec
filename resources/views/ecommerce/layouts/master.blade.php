...
<head>
    ...
    @include('ecommerce.layouts.head-css')
</head>
...
<body data-layout="vertical" data-sidebar="dark">
    <div id="layout-wrapper">
        ...
        @include('ecommerce.layouts.horizontal')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="stateForm" action="{{ route('ecommerce.save.state') }}" method="POST">
                                @csrf
    ...
    @include('ecommerce.layouts.right-sidebar')
    @include('ecommerce.layouts.vendor-scripts')
</body>
