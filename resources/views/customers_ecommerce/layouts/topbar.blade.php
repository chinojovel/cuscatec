    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a  href="{{ route('customer.ecommerce.categories') }}" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a  href="{{ route('customer.ecommerce.categories') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('assets/images/logo-sm.svg') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <form id="logout-form" action="{{ route('customer.ecommerce.seller.logout') }}" method="POST" style="display: none;">
                        @csrf
                    </form>
                </div>
            </div>
