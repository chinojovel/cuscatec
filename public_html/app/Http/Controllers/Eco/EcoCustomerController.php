...
class EcoCustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('ecommerce.customers.index', compact('customers', 'states'));
    }
    ...
    public function show($id)
    {
        ...
        $states = State::all();
        if (is_null($customer)) {
            return redirect()->route('ecommerce.customers.index')->with('error', 'Customer not found');
        }

        return view('ecommerce.customers.show', compact('customer', 'states'));
    }
    ...
    public function create()
    {
        ...
        $states = State::all();
        return view('ecommerce.customers.create', compact('states'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ecommerce.customers.index')->with('success', 'Customer created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        // Obtiene todos los estados para llenar un desplegable en la vista
        $states = State::all();
        return view('ecommerce.customers.edit', compact('customer', 'states'));
    }
