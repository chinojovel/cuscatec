...
use App\Mail\CustomerCredentialsUpdated;
...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       // $user->assignRoleAndSync('customer'); //NUEVO
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->filled('email')  && $request->filled('password')) {
            try {
                Mail::to($customer->user->email)->send(new CustomerCredentialsUpdated($customer->user->email, $request->input('password')));
            } catch (\Exception $e) {
