...
class CustomerEcoOrderSellerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Filtro por Cliente
        $ordersQuery->where('customer_id', Auth::user()->customer_id);
        ...
        return view('customers_ecommerce.orders.index', compact('orders', 'customers', 'states'));
    }
    ...
    public function show($id)
    {
        ...
        return view('customers_ecommerce.orders.show', compact('order', 'states'));
    }
    ...
    public function showUpdateStatusForm($id)
    {
        ...
        return view('customers_ecommerce.orders.update-status', compact('order', 'states'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('customers_ecommerce.orders.edit', compact('order', 'states', 'customers', 'products'));
    }
    ...
    public function modifiedOrders(Request $request)
    {
        ...
        return view('customers_ecommerce.orders.modified', compact('orders', 'customers', 'states'));
    }
}
