    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li>
                    <a href="{{ route('ecommerce.categories') }}">
                ...
                <li>
                    <a href="{{ route('ecommerce.customers.index') }}">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('ecommerce.orders.index') }}" data-key="t-read-email">Orders</a>
                        </li>
                        <li><a href="{{ route('ecommerce.orders.modified') }}" data-key="t-read-email">Modified
                                Orders</a></li>
                    </ul>
                </li>
